...
ActiveRecord::Schema.define(version: 2020_06_12_043026) do
  ...
  create_table "post_category_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.bigint "post_id"
